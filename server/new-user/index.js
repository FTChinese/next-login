...
const {handleJoiErr, handleApiErr} = require('../../utils/errors');
...
router.post('/', async (ctx, next) => {
  ...
  try {
    ...
    /**
     * @type {{id: string, name: string, email: string, avatar: string, siVip: boolean, verified: boolean}}
     */
    const u = resp.body;
